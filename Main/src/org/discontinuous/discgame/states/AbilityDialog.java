...
public class AbilityDialog extends State {
    ...
    public static void drawBatch(SpriteBatch batch, BitmapFont font, Ability ability_selected, int dialog_width_offset, int player_dialog_height_offset) {
        StateHandling.animateGain(batch, true);
        ability_selected.drawDialog(batch, dialog_width_offset, 200 + player_dialog_height_offset, 380);
